                        ...
                        <div class="card-body">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="font-22 ms-auto">
                                    @if($isSuperAdmin || $isPipelineAdmin || UserPermission::hasPermissionInPipeline($userAuth, $pipelineId, 'emails_sender_email_list') )
                                    
                                        <a href="{{ route('sender_emails.index') }}" class="btn btn-danger btn-sm">
                                            Sender Emails
                                        </a>
                                    @endif
                                    @if($isSuperAdmin || $isPipelineAdmin || UserPermission::hasPermissionInPipeline($userAuth, $pipelineId, 'emails_template_create') )
                                        ...
                                        <table class="table align-middle mb-0 table-hover data-table">
                                            ...
                                            <tbody>
                                                @foreach ($emailTemplates as $emailTemplate)
                                                    <tr>
                                                        <td><a @if($isSuperAdmin || $isPipelineAdmin || UserPermission::hasPermissionInPipeline($userAuth, $pipelineId, 'emails_template_show') ) href="{{ route('emails.show', $emailTemplate->id) }}" @endif>{{$emailTemplate->name}}</a></td>
