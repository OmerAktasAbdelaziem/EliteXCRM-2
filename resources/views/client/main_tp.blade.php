            ...
            <div class="row">
                                            ...
                                            <form class="row g-3 ajax-form" action="{{ route('mainTp.update',$client->id) }}" method="POST" name="addform" id="addform" data-tab="info">
                                                ...
                                                <div class="col-md-6 mt-0">
                                                    ...
                                                    @if (isset($options['leads_show_first_name']))
                                                        <div class="input-group">
                                                            <input type="text" @if(isset($options['mainTp_first_name'])) name="first_name" @endif readonly value="{{ old('first_name',$client->first_name) }}" class="form-control @if(isset($options['mainTp_first_name'])) editable @endif" id="first_name" placeholder="First Name"  />
                                                        </div>
                                                        @error('first_name')
                                                ...
                                                <div class="col-md-6 mt-0">
                                                    ...
                                                    @if (isset($options['leads_show_last_name']))
                                                        <div class="input-group">
                                                            <input type="text" class="form-control @if(isset($options['mainTp_last_name'])) editable @endif" id="last_name" @if(isset($options['mainTp_last_name'])) name="last_name" @endif readonly value="{{ old('last_name',$client->last_name) }}" placeholder="Last Name"/>
                                                        </div>
                                                        @error('last_name')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @if (isset($options['leads_show_email']))
                                                        <div class="input-group">
                                                            <input type="mail" class="form-control @if(isset($options['mainTp_email'])) editable @endif" id="email" @if(isset($options['mainTp_email'])) name="email" @endif value="{{ old('email',$client->email) }}" readonly placeholder="Email Address" />
                                                        </div>
                                                        @error('email')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @if (isset($options['leads_show_phone1']))
                                                        <div class="input-group">
                                                            <input type="tel" class="form-control @if(isset($options['mainTp_phone1'])) editable @endif" id="phone1" @if(isset($options['mainTp_phone1'])) name="phone1" @endif readonly value="{{ old('phone1',$client->phone1) }}" placeholder="Primary Number"/>
                                                        </div>
                                                        @error('phone1')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @if (isset($options['leads_show_phone2']))
                                                        <div class="input-group">
                                                            <input type="tel" class="form-control @if(isset($options['mainTp_phone2'])) editable @endif" id="phone2" @if(isset($options['mainTp_phone2'])) name="phone2" @endif readonly value="{{ $client->phone2 }}" placeholder="Secondary Number"/>
                                                        </div>
                                                        @error('phone2')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @if (isset($options['leads_show_username']))
                                                        <div class="input-group">
                                                            <input type="text" class="form-control @if(isset($options['mainTp_username'])) editable @endif" id="username" @if(isset($options['mainTp_username'])) name="username" @endif value="{{ old('username',$client->username) }}" readonly placeholder="Username" />
                                                        </div>
                                                        @error('username')
                                                            <div class="text-danger">{{ $message }}</div>
                                                        @enderror
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @if (isset($options['leads_show_pass']))
                                                        <div class="input-group">
                                                            <input type="text" class="form-control password @if(isset($options['mainTp_pass'])) editable @endif" id="password" readonly @if(isset($options['mainTp_pass'])) name="password" @endif value="{{ old('password',$client->password_text) }}"/>
                                                ...
                                                <div class="col-12">
                                                    ...
                                                    @if (isset($options['leads_show_usdt']))
                                                        <div class="input-group">
                                                            <input type="text" class="form-control @if(isset($options['mainTp_usdt'])) editable @endif" readonly id="usdt" @if(isset($options['mainTp_usdt'])) name="usdt" @endif value="{{ old('usdt',$client->usdt) }}" placeholder="USDT Address" />
                                                        </div>
                                                        @if (!$client->usdt)
                                                            <div class="text-red">
                                                                Default : 
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    @if (isset($options['leads_show_leverage']))
                                                        <div class="input-group">
                                                            <input type="text" class="form-control @if(isset($options['mainTp_leverage'])) editable @endif" @if(isset($options['mainTp_leverage'])) name="leverage" @endif readonly id="leverage" value="{{$client->leverage }}" placeholder="Leverage" />
                                                        </div>
                                                    @else
                                                        <div>
                                                            ******
                ...
                @if(isset($options['mainTp_cards_comments']) || isset($options['mainTp_cards_chat']))
                    <div class="col-lg-3 col-md-6 col-12 mt-2 comment-tab @if ($tab == 'history') d-none @endif">
                        ...
                        @endif
                        <br>
                        @if(isset($options['mainTp_cards_chat']))
                            @include("client.chat",['client' => $client,'chat' => $chat,'add' => isset($options['mainTp_add_chat']), 'update' => true, 'delete' => true])
                        @endif
                    </div>
                @endif
                @if(isset($options['mainTp_cards_actions']))
