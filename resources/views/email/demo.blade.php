...
<div class="email-container">
    ...
    <div class="email-body ar">
        ...
        <p>{{$data['name']}}</p>
        <p>نشكرك على اهتمامك بفتح حساب تجريبي مع {{$data['company']}}!</p>
        ...
        <div class="details">
            <table>
                <tr>
                    <td>اسـم الـمـسـتـخـدم : </td>
                    <td>{{$data['username']}}</td>
                </tr>
                <tr>
                    <td>كــلــمــة الــســر : </td>
                    <td>{{$data['password']}}</td>
                </tr>
                <tr>
                    <td>الــرصــيــد : </td>
    ...
    <div class="email-body">
        <h2>Login details</h2>
        <p>Dear {{$data['name']}},</p>
        <p>Thank you for your interest in opening a Demo account with {{$data['company']}}!</p>
