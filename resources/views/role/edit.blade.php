...
<?php /*                                        <div class="action-item"><div class="action-label"><svg class="action-icon" fill="currentColor" viewBox="0 0 20 20"><path d="M10 12a2 2 0 100-4 2 2 0 000 4z"/><path fill-rule="evenodd" d="M.458 10C1.732 5.943 5.522 3 10 3s8.268 2.943 9.542 7c-1.274 4.057-5.064 7-9.542 7S1.732 14.057.458 10zM14 10a4 4 0 11-8 0 4 4 0 018 0z" clip-rule="evenodd"/></svg>View Roles</div><input type="checkbox" class="custom-checkbox" name="roles[roles_view]" @roleHasPermission($role, 'roles_view') checked @endroleHasPermission></div>*/ ?>
                            ...
                            <div class="permission-item" data-permission="wallets">
                                ...
                                <div class="permission-actions">
                                    <div class="actions-grid">
                                        <div class="action-item list-permission"><div class="action-label">Wallets List</div><input type="checkbox" class="custom-checkbox" name="roles[wallet_list]" @roleHasPermission($role, 'wallet_list') checked @endroleHasPermission></div>
                                        <div class="action-item dependent-permission dependency-tooltip">
                                            <div class="action-label">
                                                <!-- New icon: Eye -->
                                                <svg class="action-icon" fill="currentColor" viewBox="0 0 20 20">
                                            ...
                                            <input type="checkbox" class="custom-checkbox" name="roles[wallet_view]" @roleHasPermission($role, 'wallet_view') checked @endroleHasPermission>
                                        </div>
                                        <div class="action-item dependent-permission dependency-tooltip">
                                            <div class="action-label">
                                                <!-- New icon: Plus -->
                                            ...
                                            <input type="checkbox" class="custom-checkbox" name="roles[wallet_create]" @roleHasPermission($role, 'wallet_create') checked @endroleHasPermission>
                                        </div>
                                        <div class="action-item dependent-permission dependency-tooltip">
                                            <div class="action-label">
                                                <!-- New icon: Pencil/Edit -->
                                            ...
                                            <input type="checkbox" class="custom-checkbox" name="roles[wallet_edit]" @roleHasPermission($role, 'wallet_edit') checked @endroleHasPermission>
                                        </div>
                                        <div class="action-item dependent-permission dependency-tooltip">
                                            <div class="action-label">
                                                <!-- New icon: Trash/Delete -->
                                            ...
                                            <input type="checkbox" class="custom-checkbox" name="roles[wallet_delete]" @roleHasPermission($role, 'wallet_delete') checked @endroleHasPermission>
                                        </div>
                                    </div>
                                </div>
                            </div>
