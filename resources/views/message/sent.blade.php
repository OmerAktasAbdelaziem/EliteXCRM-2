                ...
                <div class="page-content">
                    <div class="chat-wrapper my-5">
                                        ...
                                        <div class="chat-list">
                                            ...
                                            <ul class="p-0">
                                                @foreach ($messages as $messag)
                                                    @php
                                                        if ($message->recipient->lastseen_at != null) {
                                                            if(Carbon\Carbon::parse($message->recipient->lastseen_at)->diffInMinutes(Carbon\Carbon::now()) <= 5){
                                                                $userstatus='online';
                                                    ...
                                                    @endphp
                                                    <li>
                                                        <a href="{{ route('messages.sentshow',$messag->id) }}" class="list-group-item">
                                                            <div class="d-flex">
                                                                <div class="chat-user-{{$userstatus}}">
                                                                    @if ($messag->recipient->gender && $messag->recipient->gender == 'Female')
                                                                ...
                                                                <div class="flex-grow-1 ms-2">
                                                                    <h6 class="mb-0 chat-title">{{$messag->recipient->first_name}} {{$messag->recipient->last_name}}</h6>
                                                                    <p class="mb-0 chat-msg">{{substr($messag->text, 0, 25)}}.</p>
                                                                </div>
                        ...
                        <div class="chat-header d-flex align-items-center">
                            ...
                            <div>
                                <h4 class="mb-1 font-weight-bold">{{$message->recipient->first_name}} {{$message->recipient->last_name}} ({{$message->recipient->username}})</h4>
                        ...
                        <div class="chat-footer d-flex align-items-center">
                            <div class="flex-grow-1 pe-2">
                                <div class="input-group">	<span class="input-group-text"><i class='bx bx-message'></i></span>
                                    <form action="{{ route('message.store',$message->recipient->id ) }}" class="hidden" id="newmassage" name="newmassage" method="POST">
                                        @csrf
                                    </form>
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <div class="email-form">
                                        <form action="{{ route('messages.send') }}" method="POST" name="newmessage2" id="newmessage2">
                                            @csrf
                                        </form>
                                        <div class="mb-3">
                                            <div class="input-group">
                                                <select class="single-select form-select" name="recipient_id" form="newmessage2" required>
                                        ...
                                        <div class="mb-3">
                                            <textarea class="form-control" name="text" form="newmessage2" placeholder="Message" rows="10" cols="10" required></textarea>
                                        </div>
                                        <div class="mb-0">
                                            <div class="d-flex align-items-center">
                                                <div class="">
                                                    <div class="btn-group">
                                                        <button type="submit" form="newmessage2" class="btn btn-primary">Send</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
